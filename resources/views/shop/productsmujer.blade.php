        ...
        <div class="row">
            <div class="col-lg-3">
                ...
                <div class="list-group product-category mb-5">
                    <a href="{{route('shop.products.mujer')}}" class="nav-link">Todos</a>
                    <a href="{{route('shop.products.mujer',['category'=>'Casaca'])}}" class="nav-link">Casacas</a>
                    <a href="{{route('shop.products.mujer',['category'=>'Jean'])}}" class="nav-link">Jeans</a>
                </div>
            </div>
            <div class="col-lg-9">
